...
//                     pdf.setFontSize(10);
//                     let pageInfo = 'Página ' + i + ' de ' + total;
//                     let textWidth = pdf.getStringUnitWidth(pageInfo) * pdf.internal.getFontSize() / pdf.internal.scaleFactor;
//                     let textOffset = (pageWidth - textWidth) / 2; // Centrar el texto horizontalmente
//                     pdf.text(pageInfo, textOffset, pageHeight - 10); // Ajustar verticalmente cerca del fondo de la página
//                 }
//                 pdf.save('documento.pdf');
...
//                         lastY = 5;
//                     }
//                     pdf.addImage(imgData, 'PNG', margin, lastY, pageWidth, imgHeight);
//                     lastY += imgHeight;
//                 } catch (e) {
//                     console.error('Error al añadir imagen al PDF:', e);
//                 }
...
// 		const margin = 10;  // Márgenes laterales de 20mm
//         const pageWidth = pdf.internal.pageSize.getWidth() - 2 * margin;
//         const pageHeight = pdf.internal.pageSize.getHeight() - margin; // Ajuste para margen superior
...
//                     let pageInfo = 'Página ' + i + ' de ' + total;
//                     let textWidth = pdf.getStringUnitWidth(pageInfo) * pdf.internal.getFontSize() / pdf.internal.scaleFactor;
//                     let textOffset = (pageWidth - textWidth); // Centrar el texto horizontalmente
//                     pdf.text(pageInfo, textOffset, pageHeight - 10); // Ajustar verticalmente cerca del fondo de la página
//                 }
//                 pdf.save('documento.pdf');
//                 document.body.removeChild(iframe);
...
// 		 // Define la altura del margen deseado para el nuevo inicio de página
// 		 const topMargin = 20; // por ejemplo, un margen superior de 20mm

// 		// Asumir la primera imagen siempre cabe en una sola página
// 		let positionY = 0; // Posición inicial en la primera página

// 		pdf.addImage(imgData, "PNG", 0, positionY, pageWidth, imgHeight / imgWidth * pageWidth);

// 		// Comprobar y añadir nuevas páginas si el contenido es más largo que una página
...
// 	// Especificar la URL del archivo HTML externo
// 	iframe.src = "vistas/pagesPdfs/documento.php";
//   };
...
//   iframe.onload = function () {
//     // Ajusta el scroll para asegurarte de capturar todo el contenido
...
//         ((imgHeight / canvas.width) * pageWidth) / pageHeight
//       );
...
//           "PNG",
//           0,
//           -(pageHeight * j), // Posición Y para empezar a dibujar la nueva "tira" de la imagen
//           pageWidth,
//           (imgHeight / canvas.width) * pageWidth, // Escala la altura para mantener la proporción
//           null,
//           "FAST"
//         );
//       }
