$(document).ready(function () {
    ...
    let tbgranalla = $("#tbgranalla").DataTable({
        responsive: true,
        paging      : true,
        retrieve: true,
        pageLength  : 10,
       ...
       "ajax": {
           "method": "POST",
           "url": "ajax/tabletablegranalla.ajax.php"
    ...
    $("#btnActualizargranalla").click(function () {
        mostrarLoader();
        $.ajax({
          type: "POST",
          url: "modelos/enviogranalla.php",
          success: function (data) {
             ...
             if (Conta>0 ) {
               ...
               tbgranalla.ajax.reload(null, false);
               ocultarLoader();
             } else {
               Swal.fire({
                 icon: "success",
