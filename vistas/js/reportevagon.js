...
function obtenertabla() {
  ...
  dom: 'Bfrtip',
         ...
         
        {
          ...
          titleAttr: 'Reporte De Vagones',
            title:     'Vagones-'+fechaFormatoInicio.toLocaleDateString('en-US')+'-'+fechaFormatoFin.toLocaleDateString('en-US'),
          exportOptions: {
              columns: [ 2,1, 3, 4,5,6,7 ],
          }
      },
    ...
    ajax: {
      url: 'vistas/recursos/json/vagones.json', // Cambia la URL a tu archivo JSON
      dataSrc: ''
  },
  ...
  columns: [
    { data: 'pk' },
    { data: 'supervisor' },
    { data: 'alias_produccion' },
    { data: 'veces_regranallado' },
    { data: 'serie_proyecto' },
    { data: 'nombre_cabina' },
    { data: 'fecha_granallado' },
    { data: 'status' }
],
columnDefs: [
