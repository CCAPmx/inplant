$(document).ready(function () {
    ...
    let tbBodega = $("#tbBodega").DataTable({
        responsive: true,
        paging      : true,
        retrieve: true,
        pageLength  : 10,
       ...
       "ajax": {
           "method": "POST",
           "url": "ajax/tablemovimientos.ajax.php"
    ...
    $("#btnActualizarmov").click(function () {
        mostrarLoader();
        $.ajax({
          type: "POST",
          url: "modelos/enviomovimiento.php",
          success: function (data) {
             ...
             if (Conta>0 ) {
               ...
               tbBodega.ajax.reload(null, false);
               ocultarLoader();
             } else {
               Swal.fire({
                 icon: "success",
