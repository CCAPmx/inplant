...
<div class="container-fluid p-0">
    <div class="d-flex bd-highlight p-0 text-white" style="background-color: #07B5E8;">
        <div class="my-2 mx-2 flex-grow-1 bd-highlight">Granulometría</div>
        <ol class="my-2 mx-2 breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="inicio">Inicio</a></li>
            <li class="breadcrumb-item active">Granulometría</li>
        </ol>
    </div>
        ...
        <div class="col-md-12">
            <div class="card card-info">
                <div class="card-header d-flex justify-content-between">
                    <h5 class="card-title">Catalogo de Granulometría</h5>
                    <!-- <button id="btnNuevousuario" type="button" class="btn btn-primary">
                        Agregar Granulometría
                    </button> -->
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <button type="button" class="btn btn-success mx-2" id="btnActualizargranulo">
                ...
                <div class="card-body caja">
                    ...
                    <table id="tbgrano" class="table table-striped dt-responsive nowrap" style="width:100%">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Fecha</th>
...
<script>
    /* menu */
    document.getElementById('Granulometriasuper').classList.toggle('active');  
