                    ...
                    <form class="row g-3 text-center">
                        <div class="row mt-3">
                            <div class="col-md-4 mb-3 text-center">
                                <label for="">Reporte Del Día</label>
                            </div>
                            <div class="col-md-8 mb-3 text-center">
                                <button type="button" class="btn btn-outline-info col-12 mx-auto" id="btndia">Generar</button>
                            </div>
                            <div class="col-md-4 text-center">
                                <label for="">Reporte Diario</label>
                            </div>
                            <div class="col-md-8 mb-3 text-center">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="daypicker" placeholder="Seleccionar Día">
                                </div>
                            </div>
                            <div class="col-md-4 text-center">
                            ...
                            <div class="col-md-8 mb-3 text-center">
                                <input type="text" class="form-control" id="weekpicker" placeholder="En desarrollo" readonly>
                            </div>
                            <div class="col-md-4 text-center">
                                <label for="">Reporte Mensual</label>
                            </div>
                            <div class="col-md-8 mb-3 text-center">
                                <input type="text" class="form-control" id="monthpicker" placeholder="En desarrollo" readonly>
                            </div>
                        </div>
                    </form>
                </div>
...
<script src="vistas/js/maqclientes.js"></script>
...
<script>
    /* menu */
    document.getElementById('maqclientes_menu').classList.toggle('active');
