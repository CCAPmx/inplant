...
<div class="container-fluid p-0">
    <div class="d-flex bd-highlight p-0 text-white" style="background-color: #07B5E8;">
        <div class="my-2 mx-2 flex-grow-1 bd-highlight">Mantenimiento</div>
        ...
        <div class="col-md-12">
            <div class="card card-info">
                <div class="card-header d-flex justify-content-between">
                    <h5 class="card-title">Catalogo de Mantenimiento</h5>
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <button type="button" class="btn btn-success mx-2" id="btnActualizarcont">
                ...
                <div class="card-body">
                    ...
                    <table id="tbMantenimiento" class="table table-striped dt-responsive nowrap" style="width:100%">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Nombre</th>
...
<script>
    /* menu */
    document.getElementById('Mantenimientosuper').classList.toggle('active');  
