...
<div class="container-fluid p-0">
    <div class="d-flex bd-highlight p-0 text-white" style="background-color: #07B5E8;">
        <div class="my-2 mx-2 flex-grow-1 bd-highlight">Bodega</div>
        ...
        <div class="col-md-12">
            <div class="card card-info">
                <div class="card-header d-flex justify-content-between">
                    <h5 class="card-title">Catalogo de Bodega</h5>
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <button type="button" class="btn btn-success mx-2" id="btnActualizarmov">
                ...
                <div class="card-body caja">
                    ...
                    <table id="tbBodega" class="table table-striped dt-responsive nowrap" style="width:100%">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Tipo</th>
...
<script>
    /* menu */
    document.getElementById('Bodegasuper').classList.toggle('active');  
