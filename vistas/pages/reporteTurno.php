                ...
                <div class="card-body">
                    ...
                    <form class="row text-center">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-md-2 col-sm-12 my-2 text-center">
                                <button type="button" class="btn btn-outline-info btn-sm" id="btnsemact" >Semana Actual</button>
                            </div>
                           
                            <div class="col-md-2 col-sm-12 my-2 text-center">
                                <button type="button" class="btn btn-outline-info btn-sm" id="btnsempas">Semana Pasada</button>
                            </div>

                            <div class="col-md-2 col-sm-12 my-2 text-center">
                                <button type="button" class="btn btn-outline-info btn-sm" id="btnmesact">Mes Actual</button>
                            </div>

                            <div class="col-md-2 col-sm-12 my-2 text-center">
                                <button type="button" class="btn btn-outline-info btn-sm" id="btnmespas">Mes Pasado</button>
                            </div>
                    ...
                    <table id="miTabla" class="display compact row-border" style="width:100%">
                        <thead>
                        <tr>
                            <th>Fecha</th>
                            <th>Turno</th>
...
document.getElementById('infoTurno_menu').classList.toggle('active');
