...
<div class="container-fluid p-0">
    <div class="d-flex bd-highlight p-0 text-white" style="background-color: #07B5E8;">
        <div class="my-2 mx-2 flex-grow-1 bd-highlight">Granalla</div>
        <ol class="my-2 mx-2 breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="inicio">Inicio</a></li>
            <li class="breadcrumb-item active">Granalla</li>
        </ol>
    </div>
        ...
        <div class="col-md-12">
            <div class="card card-info">
                <div class="card-header d-flex justify-content-between">
                    <h5 class="card-title">Catalogo de Granalla</h5>
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <button type="button" class="btn btn-success mx-2" id="btnActualizargranalla">
                ...
                <div class="card-body caja">
                    ...
                    <table id="tbgranalla" class="table table-striped dt-responsive nowrap" style="width:100%">
                        <thead>
                            <tr>
                                <th>#</th>
                                ...
                                <th>salidas</th>
                                <th>stock</th>
                                <th>constante_entrada</th>
                                <th>constante_salida</th>
                                <th>nivel_critico</th>
                                <th>demora</th>
                                <th>gr_clientes</th>
                                <th>Operaciones</th>
            ...
            <form id="Frmusuarios" class="row g-2" role="form" method="post" autocomplete="off">
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-2  my-3">
                            <div class="form-check my-3">
                            <input class="form-check-input" type="checkbox" id="CheckBodega">
                            <label class="form-check-label" for="CheckBodega">
                               Bodega
                            </label>
                            </div>
                        </div>
...
<script>
    /* menu */
    document.getElementById('Granallasuper').classList.toggle('active');  
