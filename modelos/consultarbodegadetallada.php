...
if (isset($_POST["fecha"])) {
    ...
    $payloadName = '{"query": [{"fecha": "'. $_POST["fecha"] .'","fkgranalla": "'. $_POST["fkgranalla"] .'","tipo": "'. $_POST["tipo"] .'","Maquinas_rel::descripcion": "'. $_POST["descripcion"] .'"}],
    "sort":[
        {"fieldName": "zzHcreo", "sortOrder": "descend"}
    ]}';
    ...
    $tablahoy = array();
         for ($i = 0; $i < $Contar; $i++) {
            $Hcreo=$requestAll->response->data[$i]->fieldData->{'fecha'};
        ...
        $jsonData = json_encode($tablahoy);
         ...
         $nombreArchivo = 'bodegadetalle.json';
