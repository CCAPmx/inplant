...
if (isset($_POST["pk"])) {
    ...
    $host = 'https://fms.lersan.com/fmi/data/v1/databases/CCAP/layouts/turnos_web/_find';
    $payloadName = '{
        "query": [{"fk_modo_turno":"' . $_POST["pk"] . '"}]
    }';
    ...
    for ($i = 0; $i < $Contarord; $i++) {
        ...
        $descripcion = $requestmaq->response->data[$i]->fieldData->{'nombre'};
