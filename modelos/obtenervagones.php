...
if (isset($_POST["pk"])) {
    ...
    $host = 'https://fms.lersan.com/fmi/data/v1/databases/CCAP/layouts/TiposProductos/_find';
    $payloadName = '{
    ...
    $vagones = array(); //creamos un array
    ...
    for ($i = 0; $i < $Contarord; $i++) {
        ...
        $vagones[] = array('pk'=> $pk,'descripcion'=> $descripcion);
        
    }


     $json_string = json_encode($vagones);
     echo  $json_string;
